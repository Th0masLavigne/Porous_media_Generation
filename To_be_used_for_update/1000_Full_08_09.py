...
# Done in meters
# 
from custom_functions_08_09 import *
...
if __name__ == "__main__"  :
		...
		output_filename_perm = str(number_of_seeds)+'_seed.stl'
		...
		mesh_perm = create_only_sample(vertices, edges, radius, Height, rad_i_tube, rad_e_tube, Length_tube, Diameter, Diameter_connector_mm, Diameter_connector_i, Length_connector,chamber_height,chamber_width, Ncyl, Nsph, output_filename_perm)
		#
		#
		voxel_size = 2e-4
