...
if __name__ == "__main__"  :
		...
		mesh_perm = create_permeabilitty_sample_NoIntCyl_OnlySample(vertices, edges, radius, Height, rad_i_tube, rad_e_tube, Length_tube, Diameter, Diameter_connector_mm, Diameter_connector_i, Length_connector,chamber_height,chamber_width, Ncyl, Nsph, output_filename_perm)
		# Define the outputs file names for the merged mesh, the boolean (CSG) mesh and the cleaned one
		output_filename_perm = str(number_of_seeds)+'_seed_permeabilitty.stl'
		#
		#resolution_order = 7
