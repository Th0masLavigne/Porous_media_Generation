...
if __name__ == "__main__"  :
	...
	seeds_list = [10,250,500,750,1000]
	for number_of_seeds in seeds_list:
		...
		output_filename_merged = str(number_of_seeds)+'_seed_merged.obj'
		output_filename_CSG = str(number_of_seeds)+'_seed_CSG.obj'
		output_filename_clean = str(number_of_seeds)+'_seed_clean.obj'
		output_filename_perm = str(number_of_seeds)+'_seed_permeabilitty.obj'
		output_filename_perm_clean = str(number_of_seeds)+'_seed_permeabilitty_clean.obj'
