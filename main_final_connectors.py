	...
	for number_of_seeds in seeds_list:
		...
		while continue_==True:
		    # if input('Are you satisfied with the current geometry? [y/n]: ') == 'y':		       
		        mesh_perm_top, mesh_perm_bottom = create_permeabilitty_connector(vertices, edges, radius, Height, rad_i_tube, rad_e_tube, Length_tube, Diameter, Diameter_connector_mm, Diameter_connector_i, Length_connector, Ncyl, Nsph, output_filename_perm)
